...
function importHokushin2026_3nen_2kai() {
  const gradeSheet = ensureSheet(getSpreadsheet(), '成績');
  ...
  //  国語偏, 数学偏, 社会偏, 理科偏, 英語偏, 3科偏, 5科偏]
  const students = [
    ['川崎　璃琥',  64, 67, 64, 57, 56, 308, 57.0, 63.0, 57.0, 56.0, 56.0, 59.8, 59.1],
    ['鈴木　颯人',  57, 51, 64, 54, 47, 273, 53.0, 54.0, 57.0, 55.0, 52.0, 53.9, 55.2],
    ['加藤　遥',    81, 41, 46, 49, 53, 270, 67.0, 49.0, 48.0, 52.0, 55.0, 57.6, 54.9],
    ['加藤　碧希',  64, 55, 53, 53, 38, 263, 57.0, 57.0, 51.0, 54.0, 48.0, 54.3, 54.1],
    ['田中　蒼太',  55, 54, 53, 51, 37, 250, 52.0, 56.0, 51.0, 53.0, 48.0, 52.3, 52.7],
    ['伊藤　悠弥',  49, 24, 71, 30, 50, 224, 49.0, 40.0, 60.0, 44.0, 54.0, 48.2, 49.8],
    ['徳山　遙人',  56, 40, 47, 35, 44, 222, 53.0, 48.0, 48.0, 46.0, 51.0, 51.3, 49.6],
    ['大高　要',    48, 29, 56, 43, 31, 207, 48.0, 43.0, 53.0, 50.0, 45.0, 45.5, 48.0],
    ['上原　佑理',  45, 32, 42, 44, 35, 198, 47.0, 44.0, 46.0, 50.0, 47.0, 46.3, 47.0],
    ['沢　一歩',    40, 34, 52, 48, 17, 191, 44.0, 45.0, 51.0, 52.0, 39.0, 42.2, 46.3],
    ['入江　新太',  58, 27, 33, 31, 28, 177, 54.0, 41.0, 41.0, 44.0, 44.0, 46.4, 44.8],
    ['武藤　楓',    43, 29, 47, 34, 20, 173, 46.0, 43.0, 48.0, 45.0, 40.0, 42.4, 44.3],
    ['梶村　慧',    32, 20, 32, 22, 25, 131, 40.0, 38.0, 41.0, 40.0, 42.0, 39.4, 39.3],
    ['柴田　結衣',  31, 20, 13, 11,  7,  82, 39.0, 38.0, 31.0, 35.0, 34.0, 35.9, 33.5],
  ];
